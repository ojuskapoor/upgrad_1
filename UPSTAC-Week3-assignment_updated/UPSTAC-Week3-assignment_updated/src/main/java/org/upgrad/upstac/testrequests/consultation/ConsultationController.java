...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        //List of all the tests with status as LAB_TEST_COMPLETED
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        //Find the test requests for the logged in doctor
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        //Assign test requests to doctor
        try {
            User loggedInDoctor = userLoggedInService.getLoggedInUser();
            TestRequest testRequest = testRequestUpdateService.assignForConsultation(id, loggedInDoctor);
            return testRequest;
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        //Update the additional consultation details for a particular test

        try {
            User loggedInDoctor = userLoggedInService.getLoggedInUser();
            TestRequest testRequest = testRequestUpdateService.updateConsultation(id, testResult, loggedInDoctor);
            return testRequest;
